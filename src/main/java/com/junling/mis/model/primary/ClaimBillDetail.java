...
public class ClaimBillDetail extends ClaimBillDetailKey {
    ...
    private Integer paymentItemPrice;
    ...
    private Integer claimItemAmount;

    private Integer claimItemRate;
    ...
    public Integer getPaymentItemPrice() {
        return paymentItemPrice;
    }

    public void setPaymentItemPrice(Integer paymentItemPrice) {
    ...
    public Integer getClaimItemAmount() {
        return claimItemAmount;
    }

    public void setClaimItemAmount(Integer claimItemAmount) {
        this.claimItemAmount = claimItemAmount;
    }

    public Integer getClaimItemRate() {
        return claimItemRate;
    }

    public void setClaimItemRate(Integer claimItemRate) {
