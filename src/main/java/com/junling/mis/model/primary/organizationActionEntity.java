...
public class organizationActionEntity {
    private String organizationActionId;
    ...
    public String getOrganizationActionId() {
        return organizationActionId;
    }

    public void setOrganizationActionId(String organizationActionId) {
        this.organizationActionId = organizationActionId == null ? null : organizationActionId.trim();
    }
