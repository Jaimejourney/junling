...
public class PaymentItemRelation {
    ...
    private Integer paymentClaimRate;
    ...
    public Integer getPaymentClaimRate() {
        return paymentClaimRate;
    }

    public void setPaymentClaimRate(Integer paymentClaimRate) {
