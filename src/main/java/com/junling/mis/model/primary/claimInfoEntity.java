...
public class claimInfoEntity extends claimInfoEntityKey {
    ...
    private BigDecimal examEstimateAmount;
    ...
    public BigDecimal getExamEstimateAmount() {
        return examEstimateAmount;
    }

    public void setExamEstimateAmount(BigDecimal examEstimateAmount) {
        this.examEstimateAmount = examEstimateAmount;
    }

    public BigDecimal getExamAmount() {
        return examAmount;
    }

    public void setExamAmount(BigDecimal examAmount) {
