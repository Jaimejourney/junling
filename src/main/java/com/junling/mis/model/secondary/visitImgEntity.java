...
public class visitImgEntity {
    ...
    public String getExistsXz() {
        return existsXz;
    }

    public void setExistsXz(String existsXz) {
        this.existsXz = existsXz == null ? null : existsXz.trim();
    }
