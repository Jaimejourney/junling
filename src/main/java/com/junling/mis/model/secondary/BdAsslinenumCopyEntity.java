...
public class BdAsslinenumCopyEntity {
    ...
    public String getPkAsslinenum() {
        return pkAsslinenum;
    }

    public void setPkAsslinenum(String pkAsslinenum) {
        this.pkAsslinenum = pkAsslinenum == null ? null : pkAsslinenum.trim();
    }
