...
////
////    Result listTbDistrictPage(TbDistrictModel tbDistrictModel) throws Exception;
////
////	Result countTbDistrict(TbDistrictModel tbDistrictModel) throws Exception;
//
//	Boolean deleteTbDistrict(String districtCode) throws Exception;
}